...
func (m *MockUserService) LoginByLoginOrEmail(ctx context.Context, loginOrEmail, password string) (*userservice.UserOutput, error) {
	args := m.Called(ctx, loginOrEmail, password)
	v := args.Get(0)
	if v != nil {
		if result, ok := v.(*userservice.UserOutput); ok {
			return result, args.Error(1)
...
func (m *MockUserService) SACreateUser(ctx context.Context, input userservice.SACreateUserInput) (*userservice.UserOutput, error) {
	args := m.Called(ctx, input)
	v := args.Get(0)
	if v != nil {
		if result, ok := v.(*userservice.UserOutput); ok {
...
func (m *MockUserService) SADeleteUser(ctx context.Context, userID string) error {
	args := m.Called(ctx, userID)
	return args.Error(0)
}

func (m *MockUserService) SAListUsers(ctx context.Context, input userservice.SAListUsersInput) (*userservice.PaginatedUsersOutput, error) {
	args := m.Called(ctx, input)
	v := args.Get(0)
	if v != nil {
		if result, ok := v.(*userservice.PaginatedUsersOutput); ok {
			return result, args.Error(1)
		}
	}
	return nil, args.Error(1)
...
func TestUserHandler_Register(t *testing.T) {
	...
	handler := NewHandler(mockService, tokenManager)
...
func TestUserHandler_Login(t *testing.T) {
	...
	// Setup expectations
	mockService.On("LoginByLoginOrEmail", mock.Anything, reqBody.LoginOrEmail, reqBody.Password).Return(serviceUser, nil)
	...
	var response dto.LoginSuccessResponse
	err = json.Unmarshal(rec.Body.Bytes(), &response)
	require.NoError(t, err)
	assert.NotEmpty(t, response.AccessToken)
...
func TestUserHandler_Login_Unauthorized(t *testing.T) {
	...
	// Test input
	reqBody := dto.LoginRequest{
		LoginOrEmail: "wrong@example.com",
	...
	mockService.On("LoginByLoginOrEmail", mock.Anything, reqBody.LoginOrEmail, reqBody.Password).Return((*userservice.UserOutput)(nil), assert.AnError)
